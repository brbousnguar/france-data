  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Link href="/nantes-10-years" className="bg-white border border-[#D9D9D9] p-6 hover:shadow-md transition-shadow">
          ...
          <div className="text-center">
            <p className="text-3xl font-bold text-[#333333] mb-1">325 800</p>
            <p className="text-sm text-[#666666] font-medium">Population</p>
            <p className="text-xs text-[#999999] mt-1">Nantes 2024</p>
          </div>
        </Link>
